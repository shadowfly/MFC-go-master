...
if os.name == "nt":
    output = "mjoyd.exe"
    install_path = os.path.expanduser("~") + "/mjoy.io"
elif os.name == "posix":
    output = "mjoyd"
    install_path = "/usr/local/bin/mjoy.io"
else:
    print("unkown system")
    exit(0)
...
def main():
    ...
    build_parser = subparser.add_parser("build", help="build mjoy")
    build_parser.set_defaults(func=build)

    install_parser = subparser.add_parser("install", help="install mjoy")
    install_parser.add_argument("-d", "--dir",
                                ...
                                help="install mjoy to dir(default: %(default)s)")
    ...
    #                     dest="install_path",
    #                     metavar="PATH",
    #                     help="install mjoy to path (default: .)")
